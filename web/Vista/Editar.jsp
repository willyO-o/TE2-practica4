        ...
        <div class="container">
            ...
            <div class="jumbotron p-3 p-md-5 text-white rounded bg-dark mx-auto">
                <div class=" px-0 text-center">
                    ...
                    <p class="lead my-3">
                        Bienvenido, aqui puede Editar sus Posts 
                    </p>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="Controlador" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="titulo" value="${post.getTitulo()}" required="">
                                </div>
                                <div class="form-group">
                                    <label for="exampleFormControlTextarea1">Contenido</label>
                                    <textarea class="form-control"  rows="3" name="contenido" required=""> ${post.getContenido()}</textarea>
                                </div>
                                <input type="hidden" name="id" value="${post.getIdbg()}" >
